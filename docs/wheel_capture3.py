...
print("DONE valid packets:",len(rows))
print("addresses:", dict(Counter(r[1] for r in rows)))
print("RF channels:", dict(sorted(Counter(r[0] for r in rows).items())))
print("payloads:", {f'0x{k:02X}':v for k,v in sorted(Counter(r[2] for r in rows).items())})
